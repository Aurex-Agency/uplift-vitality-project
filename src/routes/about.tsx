  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "About Uplift Medical" },
      {
        ...
        content: "Restoring balance. Revitalizing lives. Meet the team behind Uplift Medical.",
      },
    ],
  }),
  component: About,
          ...
          <div className="md:col-span-6">
            <Reveal delay={120}>
              <p className="text-lg leading-relaxed text-foreground">
                Welcome to Uplift Medical, where we specialize in transforming lives through
                personalized medical care. Based in Tupelo, Mississippi, we are dedicated to
                exceptional healthcare tailored to the unique needs of each patient. We see
                in-person patients at our Tupelo office and serve patients across Mississippi and
                Tennessee through telehealth, supported by local lab draw stations.
              </p>
            </Reveal>
          </div>
        </div>
          ...
          <div className="md:col-span-7">
            <Reveal delay={100}>
              ...
              <div className="mt-8 space-y-5 text-base leading-relaxed text-foreground">
                <p>
                  "My name is Kenny Goolsby, owner of Uplift Medical. I have been involved in
                  fitness and health since the age of 14. With over a decade of experience reading
                  bloodwork for personal training clients and my clinical experience in various
                  clinics, I realized the dire need for hormone replacement therapy for people in
                  all walks of life."
                </p>
                <p>
                  "Hormone replacement is not only for those chasing a fitness goal. It is for
                  anyone dealing with a decline in their quality of life. I have treated teenagers,
                  middle aged adults, and people as old as 100. I have shared laughs, tears, and
                  success stories with so many people, and it has been a blessing to be part of
                  their journeys."
                </p>
                <p>
                  "At Uplift Medical, we do not see patients as just another person. We see someone
                  who deserves to be heard, consoled, and treated accordingly. I look forward to
                  meeting you, hearing your story, and being part of your journey to feeling the way
                  you have always wanted. You deserve to be Uplifted."
                </p>
              </div>
            </Reveal>
          </div>
