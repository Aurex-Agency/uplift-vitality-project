    ...
    <section className="bg-background py-20 md:py-28">
      <div className="mx-auto max-w-3xl px-6">
        ...
        <div className="mt-8 space-y-5 text-base leading-relaxed text-foreground">
          <p>
            Uplift Medical respects your privacy. This page is a placeholder for our full Privacy
            Policy. We do not sell your personal information. We use the information you provide to
            communicate with you about your care and our services.
          </p>
          <p>
            If you have questions about how we handle your information, please contact us at the
            address or phone number listed on our Contact page.
          </p>
