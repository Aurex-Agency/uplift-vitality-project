...
export function CTABand({
  ...
  return (
    <section className="relative overflow-hidden bg-primary py-20 text-cream md:py-28">
      ...
      <div className="relative mx-auto max-w-3xl px-6 text-center">
        ...
        <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <CTAButton to="/book" variant="gold">Book an Appointment</CTAButton>
          <CTAButton href={SITE.phoneHref} variant="outline" className="border-gold text-cream hover:bg-gold hover:text-primary">
            Call {SITE.phone}
          </CTAButton>
        </div>
      </div>
